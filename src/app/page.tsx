...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-gray-900 text-lg">Apprenti Révision</span>
          </div>
          <div className="flex items-center gap-3">
            <Link href="/login" className="text-sm font-medium text-gray-600 hover:text-gray-900 transition px-4 py-2 rounded-xl hover:bg-gray-100">
              Se connecter
            </Link>
      ...
      {/* HERO */}
      <section className="pt-32 pb-20 px-6 bg-gradient-to-b from-indigo-50 via-purple-50 to-white relative overflow-hidden">
        {/* Cercles décoratifs */}
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/login" className="border border-gray-200 text-gray-700 px-8 py-4 rounded-2xl font-semibold text-lg hover:bg-gray-50 transition">
              J&apos;ai déjà un compte
            </Link>
          </div>
        </div>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center text-gray-400 mb-14">Un seul outil, toutes les méthodes.</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={f.title} className={`bg-gradient-to-br ${f.color} rounded-2xl p-6 border border-white`}>
      ...
      <section className="py-20 px-6 bg-slate-50">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-center text-gray-400 mb-14">De ton cours brut à une révision complète en quelques minutes.</p>
          ...
          <div className="flex flex-col md:flex-row gap-8">
            {[
              ...
              <div key={i} className="flex-1 bg-white rounded-2xl p-6 shadow-sm border relative">
                <span className="absolute top-4 right-4 text-xs font-bold text-gray-200">{s.step}</span>
